    ...
    <>
      ...
      <div className="blog-single">
        <div className="wrapper">
          <h1>Double Dipping in Spousal Support: The Impact on BC Family Law <hr /></h1>
          <div className='info'>
            <div className="time"><MdOutlineAccessTimeFilled/> Nov 11 2019</div>
            <div className="user"><FaUser/> Barristar</div>
            <div className="category"><FaTag/>Uncategorized</div>
          </div>
          <div className="text">
            <p>Double dipping in spousal support can be a big consideration for individuals navigating divorce or separation in British Columbia.
              In some cases, courts may tell people not to “double dip” but in others, they have said that double dipping is acceptable.  Take a read below to find out what double dipping is in the family law context, and whether this is something you should be aware of in your family law dispute.</p>
            <h2>What is double dipping in spousal support?</h2>
            <p>Double dipping refers to the potential for one party to receive multiple financial benefits from the same income source, resulting in unfair outcomes.
              For example think of a couple who have divided their property upon the breakdown of their marriage.  In this example one spouse would claim continued support based on the income generated from the previously divided assets (think a pension) of the other spouse. Generally, it is considered unfair to allow the claiming spouse to reap the benefit of both the asset upon property division as well as a source of income.</p>
            <h2>What do the courts say about double dipping in spousal support?</h2>
            <p>The leading case on the issue of double dipping in spousal support is the Supreme Court of Canada (SCC) case Boston v. Boston (2001 SCC 43). In this case, the husband’s pension was worth over $300,000. The parties entered into a separation agreement that allowed him to keep this pension and a few personal belongings, while the wife kept the family home, farm, cottage and most of the savings. The agreement also set out the husband’s spousal support obligation to the wife.
